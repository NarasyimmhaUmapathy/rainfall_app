...
train_dir = 'output_data/train/model_training.csv'
test_dir = 'output_data/test/model_validation_data.csv'
ref_dir = 'output_data/ref/monitoring_reference_data.csv'
prod_dir = 'output_data/prod/monitoring_production_data.csv'
prod_predictions_dir = 'output_data/prod/prediction_production_data.csv'
